...
class Kernel extends HttpKernel
{
     ...
     *
     * These middleware can be assigned to groups of routes to apply them to a subset of routes.
     *
     * @var array
     */
    ...
    protected $routeMiddleware = [
        ...
        'role' => \App\Http\Middleware\RoleMiddleware::class,  // Agregado para manejar roles
    ];
}
